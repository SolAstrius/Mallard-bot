    ...
    vec![
        ...
        (
            ...
            vec![
                "пельмеши\u{1F60C}",
                "сметанки бы",
                "пельмень не бьёт пельменя",
                "вам с уксусом или с майонезом?",
                "лепить будем?",
        ...
        (
            ...
            vec![
                "со сметаной?",
                "вчерашний всегда вкуснее",
                "борщик это серьёзно",
                "с пампушками\u{1F60C}",
            ],
        ),
        (
            Keyword::Chai,
        ...
        (Keyword::Goyda, vec!["гойда", "гоооойдааа", "г о й д а"]),
        (
            Keyword::Sad,
            vec![
                "обниму\u{1F970}",
        ...
        (
            ...
            vec![
                "отдохни",
                "поспи минут двадцать",
                "ты молодец что дошёл досюда",
                "выпей водички",
                "*заворачивает в плед*",
            ],
        ),
        ...
        (
            Keyword::Sleepy,
            vec![
                "сладких снов\u{1F31B}",
                "баю-бай",
                "*выключает свет*",
                "увидимся утром",
                "не сиди в телефоне",
                "*укладывает в гнёздышко*",
            ],
        ),
        (
            Keyword::Hug,
